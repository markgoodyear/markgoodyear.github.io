---
title: "Meet Conditionizr"
slug: "meet-conditionizr"
layout: post
excerpt: "After much debate about a way forward past conditional statements, retina detection, and legacy content serving, Todd Motto and I have been working hard on a proposed solution: Conditionizr."
published: true
date: 2012-12-18
demo: http://conditionizr.com
download: http://github.com/conditionizr/conditionizr/archive/master.zip
fork: http://github.com/conditionizr/conditionizr
---

<p class="lead">After much debate about a way forward past conditional statements, retina detection, and legacy content serving, <a href="http://twitter.com/toddmotto" target="_blank">Todd Motto</a> and I have been working hard on a proposed solution: Conditionizr.</p>

[Conditionizr][2] is a clever tool for front-end development that detects the end-users browser and pixel ratio, allowing you to serve specific conditional JavaScript and CSS files they need.

 [2]: http://conditionizr.com/
